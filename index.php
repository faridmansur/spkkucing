...
<head>
  ...
  <base href="http://localhost/spkkucing/">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a class="btn btn-default btn-flat" <?php if ($module == "tentang")
                        echo 'class="class="btn btn-default btn-flat active"'; ?> href="?module=tentang"><i class="fa fa-info-circle"></i>
                        <span>Tentang</span></a>
                    </div>
            ...
            <div class="modal-body">
              ...
              <form role="form">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="masukkanPesan" placeholder="Masukkan pesan Anda"
                    style="min-width: 200px; max-height: 250px; min-height: 80px; max-width: 290px; margin-left: 10px; width: 270px; height: 133px;"></textarea>
                </div>
              </form>
            </div>
